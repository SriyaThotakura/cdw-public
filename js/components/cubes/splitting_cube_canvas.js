...
(function() {
    ...
    container.style.height = '400px'; // Fixed height, responsive width
    container.style.position = 'relative';
    container.style.overflow = 'hidden';
    container.style.margin = '0 auto'; // Center the container
    container.style.borderRadius = '8px';
    container.style.backgroundColor = '#1a1a2e'; // Match background color
    ...
    function init() {
        ...
        const resizeObserver = new ResizeObserver(entries => {
            updateSize();
            // Re-center camera and adjust for new aspect ratio
            if (camera) {
