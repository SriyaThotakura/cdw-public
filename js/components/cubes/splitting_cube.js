let scene, camera, renderer, raycaster, mouse, container;
let cubes = [];
...
function init() {
    ...
    container = document.getElementById('splitting-cube-container');
    if (!container) {
...
function changeSplitMode(mode) {
    splitMode = mode; // 'click', 'hover', 'motion'
}

function setSensitivity(value) {
    sensitivity = value; // 1-10
}
