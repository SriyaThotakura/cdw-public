...
(function() {
  ...
  // Get base URL from parent window or use current location
  const baseUrl = window.parent?.baseUrl || window.location.href.substring(0, window.location.href.lastIndexOf('/') + 1);
  
  // Load CSV data
  d3.csv(`${baseUrl}events.csv`).then(function(data) {
    // Parse years
    ...
    const imageMap = {
      'Neoclassicism': 'images/Neoclassicism.jpeg',
      'Romanticism': 'images/Romanticism.jpeg',
      'Realism': 'images/Realism.jpeg',
      'Impressionism': 'images/Impressionism.jpeg',
      'Post-Impressionism': 'images/Post-Impressionism.jpg',
      'Art Nouveau': 'images/Art Nouveau.jpg',
      'Fauvism': 'images/Fauvism.jpg',
      'Cubism': 'images/Cubism.jpg',
      'Expressionism': 'images/Expressionism.jpg',
      'Dada': 'images/Dada.jpg',
      'Surrealism': 'images/Surrealism.jpg',
      'Abstract Expressionism': 'images/Abstract Expressionism.jpg',
      'Pop Art': 'images/Pop Art.jpeg',
      'Minimalism': 'images/Minimalism.jpeg',
      'Conceptual Art': 'images/Conceptual Art.jpg',
      'Postmodernism': 'images/Postmodernism.jpg',
      'Contemporary Art': 'images/Contemporary Art.jpg',
    };
